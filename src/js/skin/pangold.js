...
$.gcxSpringsideBar.skins.initskin = {
	color: "red",
	background: "black",
	//默认字体颜色1
	...
	//分割线1
	line1: 'rgba(190, 120, 10, 0.98)',      //灰色
	//分割线2
	line2: 'rgba(44, 44, 51, .7)',      //灰色
	//整体   底色
	colbck_entire: ' rgba(0, 0, 0, .98)',         //黑色
	//List 模块 底色
	colbck_tabList: ' rgba(0, 0, 0, .84)',           //偏黑色
	//Action 模块 底色
	colbck_tabAction: ' rgba(190, 120, 10, 0.98)',    //蓝色
	//菜单默认 鼠标移入底色
	colbck_menuIn: 'rgba(190, 120, 10, 0.98)',      //灰色
	//下拉按钮 底色
	colbck_dropOpen: 'rgba(190, 120, 10, 0.7)',       //淡灰色
	//关闭按钮字体颜色
